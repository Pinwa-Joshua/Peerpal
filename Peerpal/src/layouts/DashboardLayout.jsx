                                        ...
                                        {notifications.length === 0 ? (
                                            ...
                                            notifications.map((msg) => (
                                                <div
                                                    ...
                                                    className={`group relative flex items-start gap-3 px-4 py-3 hover:bg-gray-50/80 transition-colors mx-2 my-1 rounded-xl cursor-pointer ${!msg.is_read ? "bg-blue-50/50" : ""
                                                        }`}
                                                >
                                                    {!msg.is_read && (
                                                        <div className="absolute left-2 top-0 bottom-0 w-1 bg-primary rounded-full my-3" />
                                                    )}
